document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateContent(letter, number, type) {
        if (type === 'alphabet') {
            ...
            const tableUrl = 'images/alphabetTable.jpg'

            tableAlphabet.src = tableUrl
            tableAlphabet.style.display = 'block';
            ...
            const videoUrl = `images/Auslan.mp4`;
            const tableUrl = 'images/numberTable.jpg'

            tableNumbers.src = tableUrl
            tableNumbers.style.display = 'block';
